...
git add -A
git commit -m "Release 0.5.9.22" 2>nul
git branch -M main
git remote get-url origin >nul 2>nul || git remote add origin https://github.com/Pfoetiman76/pitboss.git
git push -f origin main
if errorlevel 1 goto PUSHFAIL
echo - Tag v0.5.9.22 sauber neu setzen (verhindert No-Op / haengende CI)...
git tag -d v0.5.9.22 2>nul
git push origin :refs/tags/v0.5.9.22 2>nul
git tag v0.5.9.22
git push origin v0.5.9.22
