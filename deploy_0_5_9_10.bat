...
git add -A
git commit -m "Release 0.5.9.10" 2>nul
git branch -M main
...
echo - Tag v0.5.9.10 sauber neu setzen (verhindert No-Op / haengende CI)...
git tag -d v0.5.9.10 2>nul
git push origin :refs/tags/v0.5.9.10 2>nul
git tag v0.5.9.10
git push origin v0.5.9.10
