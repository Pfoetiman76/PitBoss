...
gh repo view Pfoetiman76/pitboss >nul 2>nul
if errorlevel 1 gh repo create pitboss --public --disable-wiki
...
echo    https://github.com/Pfoetiman76/pitboss/releases
goto END
:NOGIT
