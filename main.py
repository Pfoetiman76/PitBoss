...
class DamageOverlayWindow(OverlayStyleMixin, QWidget):
    ...
    def paintEvent(self, _):
        ...
        p.drawText(QRectF(10, h - 15, w - 20, 12), Qt.AlignLeft, m.diagnostics())
        p.end()
...
class WeatherOverlayWindow(OverlayStyleMixin, QWidget):
    ...
    def paintEvent(self, _):
        ...
        p.drawText(QRectF(10, 144, w - 20, 14), Qt.AlignLeft, "PROGNOSE (TREND)")
...
class BrakeTempOverlayWindow(OverlayStyleMixin, QWidget):
    ...
    def paintEvent(self, _):
        ...
        for i in range(4):
            ...
            # 0.4.9.2: geschaetzter Belagverschleiss je Rad
            if self._model is not None:
                wpct = self._model.wear_pct(i)
        ...
        if self._model is not None:
            ...
            p.drawText(QRectF(0, h - 15, w, 13), Qt.AlignCenter,
                       ...
                       + f"Verschlei\u00df gesch\u00e4tzt \u00b7 Peak {hot:.0f} \u00b0C")
        p.end()
...
"""
    ...
    def update_brake_status(self):
        ...
        txt = "Bremsen (Temp / Verschlei\u00df gesch\u00e4tzt): " + "  \u00b7  ".join(parts)
        if m.fading_risk():
            txt += "   \u2013 FADING-GEFAHR"
        lab.setText(txt)
