...
class Main(QMainWindow):
    def __init__(self):
        ...
        overflow = [self.btn_snapshot, self.btn_stop, self.btn_csv, self.btn_ref_export, self.btn_ref_import, self.btn_pb_reference, self.btn_auto_bestlap, self.btn_auto_switch, self.btn_overlay, self.btn_tire_overlay, self.btn_pedal_overlay, self.btn_export, self.btn_clear]
        for b in primary:
            buttons.addWidget(b)
        for b in overflow:
            buttons.addWidget(b)
