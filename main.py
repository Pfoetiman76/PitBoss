...
class TireMiniWidget(OverlayStyleMixin, QWidget):
    ...
    def paintEvent(self, event):
        ...
        for i in range(3):
            ...
            painter.setBrush(QBrush(self._trackcol()))
        ...
        for i, (lab, temp) in enumerate(labels):
            ...
            painter.setPen(self._muted()); painter.drawText(r1, Qt.AlignCenter, lab)
            painter.setPen(self._fg()); painter.drawText(r2, Qt.AlignCenter, f"{temp:.0f}")
...
class Main(QMainWindow):
    def __init__(self):
        ...
        _ov.addAction("Flaggen", self.toggle_flag_overlay)
        ...
        _more.addAction("Bremsmodell kalibrieren \u2026", self.calibrate_brake_model)
        _lead = _more.addMenu("Ansage-Vorlauf")  # 0.4.9.8
        ...
        self.act_spotter = _more.addAction("Spotter: Auto links/rechts (Ansagen)")
        ...
        self.act_spotter_flip = _more.addAction("Spotter: Seiten spiegeln")
...
"""
    ...
    def toggle_flag_overlay(self):
        self._toggle_simple_overlay("flag_overlay_window", FlagOverlayWindow, "Flaggen-Overlay")
